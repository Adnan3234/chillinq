...
const WhyChillinq = () => {
    ...
    return (
        <>
            ...
            <div style={{ backgroundImage: `url('/7.png')`, backgroundSize: "cover", backgroundPosition: "contain", backgroundRepeat: "no-repeat", width: "100%", height: '260px' }} className='px-8 py-10  sm:px-20 text-2xl font-bold text-white text-center sm:text-4xl space-y-6 sm:space-y-2' >
            ...
            <div className='flex flex-col items-center space-y-10 my-5 mb-20'>
                <p className='hidden sm:block font-bold text-2xl sm:text-4xl text-center '>Are you ready to <span className='text-[#DB1F48]'>chill?</span> </p>
                <div>
